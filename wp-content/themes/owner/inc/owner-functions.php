...
function owner_scripts() {
    ...
    if( $header_sticky_option != 'hide' ) {
        ...
        wp_enqueue_script( 'owner-sticky-setting', get_template_directory_uri() .'/assets/library/sticky/sticky-setting.js', array( 'jquery-sticky' ), '1.0.0', true );
    }

	wp_enqueue_script( 'owner-custom-script', get_template_directory_uri(). '/assets/js/custom-script.js', array( 'jquery' ), '1.0.0' );
	...
	wp_enqueue_style( 'owner-style', get_stylesheet_uri() );

    wp_enqueue_style( 'owner-responsive-style', get_template_directory_uri() .'/assets/css/owner-responsive.css' );
