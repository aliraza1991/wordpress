...
function twotwentyfive_post_metabox_html($post) {
   ...
   ?>
    <p>
        <label for="twotwentyfive_post_metabox_html"><?php esc_attr_e('Post SubTitle', 'twotwentyfive-metaboxes') ?></label>
        <br>
        ...
        <label for="twotwentyfive_post_layout_field"><?php esc_html_e('Layout', 'twotwentyfive-metaboxes') ?></label> <br>
        <select name="twotwentyfive_post_layout_field" class="widefat" id="twotwentyfive_post_layout_field">
            <option <?php selected($layout, 'full') ?> value="full"><?php esc_html_e('Full Width', 'twotwentyfive-metaboxes') ?></option>
            <option <?php selected($layout, 'sidebar') ?> value="sidebar"><?php esc_html_e('Post With Sidebar', 'twotwentyfive-metaboxes') ?></option>
        </select>
    </p>
   <?php
}
